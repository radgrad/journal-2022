...
Unfortunately, there have been a multitude of impacts on our degree program over the years of the RadGrad Project, ranging from curricular revisions to changes in advising personnel and process to the biggest impact of them all: COVID.  We do not claim to be able to tease out the impact of RadGrad on engagement, retention, and diversity amidst all of these other factors.  What we can do is gather perspectives from a variety of stakeholders (students, faculty, and advisors) on their view of RadGrad and use this qualitative data to assess the potential of RadGrad to impact engagement, diversity, and retention, along with insights into how to improve the project in the future.

So, during Academic Year 2021-2022, we conducted a qualitative case study that was designed to provide evidence regarding the following research questions:
...
\begin{figure}[ht]
\centering
\includegraphics[width=\linewidth]{guidedtour-degreeplan.png.eps}
