...
\item "Many opportunity announcements have a short lifespan: people are looking for students to fill a position quickly, and one's it is filled it's done. So ordering opportunities by most recent seems best (like discord). "
...
\item "I think we should adopt radgrad in ICS in a more general way. My only worry is the maintenance of it. We should discuss how to have maybe a student help position just to do the maintenance? Is that enough?"
\end{itemize}
